...
class PIDControl:
    ...
    def run(self, sensor_reading_dict, set_point_dict):
        ...
        self.pitch_controller.SetPoint = set_point_dict["pitch"]
        self.roll_controller.SetPoint = set_point_dict["roll"]
        self.yaw_controller.SetPoint = set_point_dict["yaw"]


        # update the feedback values of each controller
        self.pitch_controller.update(sensor_reading_dict["pitch"])
        self.roll_controller.update(sensor_reading_dict["roll"])
        self.yaw_controller.update(sensor_reading_dict["yaw"])

        # fuse all the outputs of the controllers together and return it in a length 4 list
        fused_output = [self.pitch_controller.output - self.roll_controller.output - self.yaw_controller.output,
